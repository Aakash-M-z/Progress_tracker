...
import { staggerContainer, navItem, fadeIn } from '@/animations/variants';
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 mr-auto">
            ...
            <span
              className="text-white font-semibold text-[13px] letter-widest uppercase tracking-[0.14em]"
          ...
          >
            <a
              ...
              className="
                rig-chamfer-btn inline-flex items-center gap-2 px-5 py-2
                bg-black text-white text-xs font-mono font-bold tracking-wider uppercase
                hover:bg-[#1A1A1E] active:scale-[0.98] transition-all duration-200 border border-white/20
              "
              data-testid="nav-cta"
            >
              LAUNCH APP
        ...
        {mobileOpen && (
          ...
          >
            ...
            <a
              href="/dashboard"
              onClick={(e) => { e.preventDefault(); navigate('/dashboard'); }}
              className="block mt-3 px-4 py-3 bg-white text-black text-sm font-semibold rounded-xl text-center"
            >
              Get Started
            </a>
          </motion.div>
